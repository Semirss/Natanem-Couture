  ...
  return (
    <div className="bg-black text-white relative overflow-hidden min-h-screen">
     ...
     <main className="flex flex-col md:flex-row items-center justify-center px-4 py-12 md:px-8 md:py-60 min-h-[calc(100vh-100px)] mx-auto">
      <div className="text-center justify-center items-center  md:text-left max-w-lg space-y-6 mb-8 md:mb-0 py-60 mx-auto">
        <h1 className="text-4xl md:text-5xl items-center  font-extrabold text-pink-600 leading-tight">
          <span className="text-white">Natanem</span> Couture
        </h1>
        <p className="text-gray-100 text-base md:text-lg items-center ">
          Our history is a modern and convenient design that is the key to successful communication with the client.
        </p>
        <div className="space-x-4 flex justify-center md:justify-start items-center ">
          <a href="#gallery">
